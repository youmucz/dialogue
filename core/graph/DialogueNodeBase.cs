...
/// </summary>
[Tool]
public partial class DialogueNodeBase : Resource
{
    #region Basics
    ...
    protected DialogueGraphResource DialogueGraphResource;
    ...
    /// 编辑器模式创建节点 @base
    /// </summary>
    /// <param name="dialogueGraphResource"></param>
    /// <param name="mGraphNode"></param>
    /// <param name="data"></param>
    public DialogueNodeBase(DialogueGraphResource dialogueGraphResource, DialogueGraphNode mGraphNode, Dictionary data)
    {
        DialogueGraphResource = dialogueGraphResource;
    ...
    /// <param name="dialogueGraphResource"></param>
    /// <param name="data"></param>
    public DialogueNodeBase(DialogueGraphResource dialogueGraphResource, Dictionary data)
    {
        DialogueGraphResource = dialogueGraphResource;
    ...
    public virtual void UpdateProperty(StringName name, Variant value)
    {
        Set(name, value);
    }
