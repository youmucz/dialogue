...
[Tool]
public partial class DialogNode : DialogueNodeBase
{
    ...
    public DialogNode(DialogueGraphResource resource, Dictionary data) : base(resource, data)
    {
    
    }

    public DialogNode(DialogueGraphResource resource, DialogueGraphNode mGraphNode, Dictionary data) : base(resource, mGraphNode, data)
    {
