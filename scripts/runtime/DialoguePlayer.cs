...
namespace Story.Dialogue.Runtime
{
	...
	{
		[Export] public DialogueGraph Dialogue;
		...
		public void LoadResource(DialogueGraph resource)
		{
			Dialogue = resource;
			Dialogue.Initialize();
		}
		...
		public bool Stop()
		{
			...
			var preNode = Dialogue.GetNodeByName(_prevNode);
			preNode?.Stop();
		...
		public void Next(string name)
		{
			...
			var curNode = Dialogue.GetNodeByName(name);
		...
		private void DoPlay()
		{
			var root = Dialogue.GetNodeByName("Root");
