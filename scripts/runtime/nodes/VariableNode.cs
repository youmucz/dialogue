...
namespace Story.Dialogue.Runtime.Nodes
{
    ...
    public partial class VariableNode : DialogueNode
    {
        ...
        [NodeMeta]
        public Dictionary<int, Dictionary> Variables { get; set; } = new() { { 0, VariableUtil.VariableDefault } };
        ...
        public VariableNode(DialogueGraph dialogueGraph, DialogueGraphNode mGraphNode, Dictionary data) : base(
